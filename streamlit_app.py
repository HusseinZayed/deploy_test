...
# Submit Button
if st.button("Submit 👇"):
        input_data = np.array([[airline_pred,source_pred,destination_pred,add_info_pred,duration_pred_scaled[0][0],stops_pred, selected_date.day, selected_date.month,dep_hour]])
